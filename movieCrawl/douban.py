...
#-*-coding:utf-8 -*-
import requests
from lxml import etree # 导入该库中 etree 以方便使用 XPath
...
"""
参考：
[XPath学习:轴(8)——following-sibling - Asharp - 博客园](http://www.cnblogs.com/zhaozhan/archive/2009/09/10/1564332.html)
[lxml - Processing XML and HTML with Python](https://lxml.de/index.html)
[Scrapy爬虫——xpath与css选择器详解 - 简书](https://www.jianshu.com/p/489c5d21cdc7)
"""